...
<html lang="en">
    <head>
        ...
        <title>Home - Blog Frozshine</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="http://localhost/pemrograman%20web/blog.php">Frozshine</a>
        ...
        <header class="py-5 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">Selamat Datang di Blog Frozshine</h1>
                    <p class="lead mb-0">Artikel seputar E-sport, hal-hal Viral, makanan, tempat wisata, dan Lain-lain</p>
                </div>
            </div>
        </header>
        <!-- Page content-->
        <div class="container">
         ...
         if(mysqli_num_rows($result) > 0){
             ...
             $data_isi = $row['isi'];
             $data_potongan_isi = potong_isi($data_isi, 50);
                     ?>
                    <div class="card mb-4">
         ...
         $result_pos2 = mysqli_query($conn, $sql_post2);
         $nomor_urut = 0;
         if(mysqli_num_rows($result_pos2) > 0){
             while($row = mysqli_fetch_assoc($result_pos2)) {
             $nomor_urut ++;
             $data_tanggal = $row['tanggal'];
             $data_judul = $row['judul'];
             $data_kategori = $row['nama_kategori'];
             ...
             $data_potongan_isi = potong_isi($data_isi, 50);
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body TentangKami">website berisi hal hal viral dan hal menarik lainnya seputar kuliner dan E-Sport. 
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Lensa Kata 2024</p></div>
        </footer>
        <!-- Bootstrap core JS-->
